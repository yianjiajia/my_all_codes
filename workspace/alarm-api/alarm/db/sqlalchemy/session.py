...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/alarm/sqlite.db",
        sqlite_db="/var/lib/alarm/sqlite.db")
...
from alarm.db import exception
from alarm.common.gettextutils import _  # noqa
from oslo_log import log as logging
from alarm.common import timeutils
...
database_opts = [
    cfg.StrOpt('connection',
               default='mysql://root:123456@localhost:3306/$mysql_db?charset=utf8',
