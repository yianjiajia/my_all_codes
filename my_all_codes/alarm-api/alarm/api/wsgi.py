...
from alarm.api import api_version_request as api_version
import versioned_method
from alarm import exception
from alarm import i18n
from alarm.i18n import _
from alarm.i18n import _LE
from alarm.i18n import _LI
from alarm import utils
from alarm import wsgi
...
# of the REST API
API_VERSION_REQUEST_HEADER = 'X-alarm-API-Version'
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'alarm.best_content_type' not in self.environ:
            ...
            self.environ['alarm.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['alarm.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('alarm.context')
